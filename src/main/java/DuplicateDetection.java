...
public class DuplicateDetection {
    ...
    public DuplicateDetection(String csvFilePath) throws MalformedCSVException, IOException {
    ...
    public void run(int numOfThreads) throws MalformedCSVException, InterruptedException, ExecutionException {
